...
int main()
{
	...
	}std::cout << "Test on the line 16 complete!" << std::endl;
	...
	} std::cout << "Test on the line 45 Complete!" << std::endl;

	if (sim.GetCPU() != 1)
	{
		allTestsClean = false;
		std::cout << "Test on the line 51 fails!" << std::endl;
	} std::cout << "Test on the line 51 Complete!" << std::endl;
	...
	} std::cout << "Test on the line 58 Complete!" << std::endl;
